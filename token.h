...
enum token_type {
    ...
    TOKEN_SLASH_ASSIGN, TOKEN_BANG, TOKEN_BANG_EQUAL, TOKEN_HASH_TAG, TOKEN_OPEN_BRACKET, TOKEN_CLOSED_BRACKET, TOKEN_ARROW,
    TOKEN_DOT, TOKEN_OR_OR, TOKEN_AND_AND,
    TOKEN_AND, TOKEN_OR, TOKEN_XOR, TOKEN_TILDE, TOKEN_AND_ASSIGN, TOKEN_OR_ASSIGN, TOKEN_XOR_ASSIGN, TOKEN_LEFT_SHIFT,
    TOKEN_RIGHT_SHIFT, TOKEN_LEFT_SHIFT_ASSIGN, TOKEN_RIGHT_SHIFT_ASSIGN, TOKEN_INCREMENT, TOKEN_DECREMENT, TOKEN_CONDITIONAL,
    TOKEN_COLON, TOKEN_QUESTION, TOKEN_MODULO_ASSIGN, TOKEN_SIZEOF, TOKEN_SINGLE_QUOTE,
    //keywords
    TOKEN_IF, TOKEN_ELSE, TOKEN_FOR, TOKEN_WHILE, TOKEN_FUN, TOKEN_VAR, TOKEN_TRUE, TOKEN_FALSE, TOKEN_NIL, TOKEN_RETURN, TOKEN_BREAK,
    TOKEN_CONTINUE, TOKEN_PRINT,
    //literal
